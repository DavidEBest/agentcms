...
<main>
	...
	<section class="hero">
		...
		<p class="subhead">
			Describe the vibe. Claude builds it. No templates, no drag-and-drop, no
	...
	<div class="marquee-wrap">
		<div class="marquee-track">
			...
			<span>artist</span>
			<span class="accent">★ generated by claude</span>
			<span>musician</span>
			<span class="accent">★ make the web weird again</span>
			<span>portfolio</span>
			<span class="accent">★ no two sites alike</span>
	...
	<section class="section" id="how">
		...
		<div class="steps">
			<div class="step">
				...
				<p>Your name, bio, gallery images, social links. The raw material Claude works with.</p>
			</div>
			<div class="step">
				<p class="step-num">02 —</p>
				<h3>Describe the vibe</h3>
				<p>"Dark and moody with huge images." "Chaotic maximalist zine energy." Claude figures out the rest.</p>
			</div>
			<div class="step">
